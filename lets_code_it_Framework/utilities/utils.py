...
class Util(object):
    ...
    def sleep(self, sec, info=""):
        ...
        """
        if info is not None:
            self.logger.info("Wait :: '" + str(sec) + "' seconds for " + info)
        try:
            time.sleep(sec)
    ...
    def verifyTextContains(self, actualText, expectedText):
        ...
        """
        self.logger.info("Actual Text From Application Web UI --> :: " + actualText)
        self.logger.info("Expected Text From Application Web UI --> :: " + expectedText)
        if expectedText.lower() in actualText.lower():
            self.logger.info("### VERIFICATION CONTAINS !!!")
            return True
        else:
            self.logger.info("### VERIFICATION DOES NOT CONTAINS !!!")
            return False
    ...
    def verifyTextMatch(self, actualText, expectedText):
        ...
        if actualText.lower() == expectedText.lower():
            self.logger.info("### VERIFICATION MATCHED !!!")
            return True
        else:
            self.logger.info("### VERIFICATION DOES NOT MATCHED !!!")
            return False
